document.addEventListener("DOMContentLoaded", function (event) {
    autocompleteVisita(document.getElementById("NSADoctor"));
});
                    ...
                    for (i = 0; i < arr.length; i++) {
                        ...
                        if ((arr[i].espec.nomespecialidad !== 'Chofer' && arr[i].espec.nomespecialidad !== 'Enfermera' && arr[i].espec.nomespecialidad !== 'Técnica en Enfermería') && (re3.test(arr[i].id) || arr[i].nombre.toUpperCase().includes(val.toUpperCase()))) {
                            ...
                            b.addEventListener("click", function (e) {
                                ...
                                const firstname = document.getElementById("FirstNameDoctor");
                                const lastname = document.getElementById("LastNameDoctor");
                                const dni = document.getElementById("DniDoctor");
                                const espec = document.getElementById("EspcDoctor");
                                const imgDoctor = document.getElementById("ImgDoctor");
